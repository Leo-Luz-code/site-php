...
/**
 * Base class that represents a row from the 'tb_admin' table.
 *
 *
 *
...
abstract class Admin implements ActiveRecordInterface
{
     ...
     * @var string
     */
    public const TABLE_MAP = '\\app\\models\\Map\\AdminTableMap';
    ...
    /**
     * The value for the tb_admin_name field.
     *
     * @var        string|null
     */
    protected $tb_admin_name;

    /**
     * The value for the tb_admin_email field.
     *
     * @var        string|null
     */
    protected $tb_admin_email;

    /**
     * The value for the tb_admin_password field.
     *
     * @var        string|null
     */
    ...
    /**
     * Initializes internal state of app\models\Base\Admin object.
     */
    ...
    /**
     * Get the [tb_admin_name] column value.
     *
     * @return string|null
     */
    public function getTbAdminName()
    {
        return $this->tb_admin_name;
    }

    /**
     * Get the [tb_admin_email] column value.
     *
     * @return string|null
     */
    public function getTbAdminEmail()
    {
        return $this->tb_admin_email;
    }

    /**
     * Get the [tb_admin_password] column value.
     *
     * @return string|null
     */
    public function getTbAdminPassword()
    {
        return $this->tb_admin_password;
    }
    ...
    /**
     * Set the value of [tb_admin_name] column.
     *
     * @param string|null $v New value
     * @return $this The current object (for fluent API support)
     */
    public function setTbAdminName($v)
    {
        if ($v !== null) {
            $v = (string) $v;
        }

        if ($this->tb_admin_name !== $v) {
            $this->tb_admin_name = $v;
            $this->modifiedColumns[AdminTableMap::COL_TB_ADMIN_NAME] = true;
        }
    ...
    /**
     * Set the value of [tb_admin_email] column.
     *
     * @param string|null $v New value
     * @return $this The current object (for fluent API support)
     */
    public function setTbAdminEmail($v)
    {
        if ($v !== null) {
            $v = (string) $v;
        }

        if ($this->tb_admin_email !== $v) {
            $this->tb_admin_email = $v;
            $this->modifiedColumns[AdminTableMap::COL_TB_ADMIN_EMAIL] = true;
        }
    ...
    /**
     * Set the value of [tb_admin_password] column.
     *
     * @param string|null $v New value
     * @return $this The current object (for fluent API support)
     */
    public function setTbAdminPassword($v)
    {
        if ($v !== null) {
            $v = (string) $v;
        }

        if ($this->tb_admin_password !== $v) {
            $this->tb_admin_password = $v;
            $this->modifiedColumns[AdminTableMap::COL_TB_ADMIN_PASSWORD] = true;
        }
    ...
    public function hydrate(array $row, int $startcol = 0, bool $rehydrate = false, string $indexType = TableMap::TYPE_NUM): int
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : AdminTableMap::translateFieldName('TbAdminName', TableMap::TYPE_PHPNAME, $indexType)];
            $this->tb_admin_name = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 2 + $startcol : AdminTableMap::translateFieldName('TbAdminEmail', TableMap::TYPE_PHPNAME, $indexType)];
            $this->tb_admin_email = (null !== $col) ? (string) $col : null;
    ...
    protected function doInsert(ConnectionInterface $con): void
    {
        ...
        if ($this->isColumnModified(AdminTableMap::COL_TB_ADMIN_NAME)) {
            $modifiedColumns[':p' . $index++]  = 'tb_admin_name';
        }
        if ($this->isColumnModified(AdminTableMap::COL_TB_ADMIN_EMAIL)) {
            $modifiedColumns[':p' . $index++]  = 'tb_admin_email';
        }
            ...
            foreach ($modifiedColumns as $identifier => $columnName) {
                switch ($columnName) {
                    case 'id':
                        ...
                        break;
                    case 'tb_admin_name':
                        $stmt->bindValue($identifier, $this->tb_admin_name, PDO::PARAM_STR);

                        break;
                    case 'tb_admin_email':
                        $stmt->bindValue($identifier, $this->tb_admin_email, PDO::PARAM_STR);
    ...
    public function getByPosition(int $pos)
    {
        switch ($pos) {
            ...
            case 1:
                return $this->getTbAdminName();

            case 2:
                return $this->getTbAdminEmail();
    ...
    public function setByPosition(int $pos, $value)
    {
        switch ($pos) {
            case 0:
                ...
                break;
            case 1:
                $this->setTbAdminName($value);
                break;
            case 2:
                $this->setTbAdminEmail($value);
                break;
            case 3:
    ...
    public function fromArray(array $arr, string $keyType = TableMap::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[1], $arr)) {
            $this->setTbAdminName($arr[$keys[1]]);
        }
        if (array_key_exists($keys[2], $arr)) {
            $this->setTbAdminEmail($arr[$keys[2]]);
        }
    ...
    public function buildCriteria(): Criteria
    {
        ...
        if ($this->isColumnModified(AdminTableMap::COL_TB_ADMIN_NAME)) {
            $criteria->add(AdminTableMap::COL_TB_ADMIN_NAME, $this->tb_admin_name);
        }
        if ($this->isColumnModified(AdminTableMap::COL_TB_ADMIN_EMAIL)) {
            $criteria->add(AdminTableMap::COL_TB_ADMIN_EMAIL, $this->tb_admin_email);
        }
        if ($this->isColumnModified(AdminTableMap::COL_TB_ADMIN_PASSWORD)) {
     ...
     * objects.
     *
     * @param object $copyObj An object of \app\models\Admin (or compatible) type.
     ...
     *
     * @param bool $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \app\models\Admin Clone of current object.
     * @throws \Propel\Runtime\Exception\PropelException
     */
